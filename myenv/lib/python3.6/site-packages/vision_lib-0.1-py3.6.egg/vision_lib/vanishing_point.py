...
def sci(values, confidence):
    """ fonction renvoyant le pourcentage des valeurs de values dans l intervalle de confiance
    values = liste
    confidence = Float """
    nb = values.shape[0]
...
def vanishing_point(lines,img):
    """ Renvoie la liste des vanishing point possibles ou None si aucune intersection n est trouvee 
    voir exemple3"""
